...
Z důvodu zveřejnění jedné vývojové větve a psaní opravdu v rychlosti, omluvte pracovní kódy. Nebudou Vám fungovat data u klientů ze sdílených disků apod. Není odladěné pro použití mimo firmu tedy ani pro lokální využití. Vše si musíte opravit dle logů.
