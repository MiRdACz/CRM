CRM pro BPR se snažím co mě čas dovolí (primární práce není programování), stavět co nejvíce odděleně (db nejlépe pro každou divizy zvlášť), ale i tak je to málo :) motivovat kolegy (zatím app píši sám) a ano je v kódu použit český jazyk (jestli bude kolega, stojí za přepsání). [ZDE](https://github.com/MiRdACz/CRM/assets/9698726/42a25108-b7d0-45aa-bf34-9e2afb3178cf) je celá aplikace. Je třeba jak nastavit config a tiny editor a vytvořit si uživatele pro přihlášení. Z důvodu zveřejnění jedné vývojové větve omluvte testovací kódy. Nebudou Vám fungovat data u klientů ze sdílených disků apod. Není odladěné mimo firmu, pro lokální využití. Aplikace chce min. PHP 8.1 viz. compouser.
